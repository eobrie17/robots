...
class SOLUTION:
    ...
    def create_body_octopod(self):
        ...
        pyrosim.Send_Cube(name="FrontLegL", pos=[-.2, 0.5, 0], size=[.2,1,.2])
        ...
        pyrosim.Send_Cube(name="LeftLowerLegR", pos=[0, .2, -.5], size=[.2,.2,1])
